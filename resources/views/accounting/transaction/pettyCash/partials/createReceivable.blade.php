                                ...
                                <div class="card-body">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="no_trans" value="{{ 'AR-C-' . date('dmy') . '-' . $kd }}"
                                                        readonly>
                                                </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="d-grid gap-2 d-md-block">
                                            ...
                                            <a href="{{ route('pettyCash') }}" class="btn btn-danger"
