                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('cashInBank.update', $cashInBank->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    {{-- <div class="form-group">
                                        ...
                                        <input type="text" class="form-control text-uppercase" name="name"
                                            id="name" value="{{ $cashInBank->name }}" placeholder="Enter Name" required>
                                    </div> --}}
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        id="debit" placeholder="0" value="{{ $cashInBank->debit }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        id="credit" placeholder="0" value="{{ $cashInBank->credit }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control form-control-sm text-uppercase" name="remarks" id="remarks" rows="3">{{ $cashInBank->remarks }}</textarea>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input" id="trans_doc"
                                                                name="trans_doc">
                                                            <label class="custom-file-label" for="trans_doc">{{ $cashInBank->trans_doc }}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="d-grid gap-2 d-md-block">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('cashInBank') }}"
