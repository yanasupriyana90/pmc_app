                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-4">
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox"
                                                                ...
                                                                onclick="showDivUndHblAll()" value="0">
                                                    ...
                                                    <div class="col-1" hidden>
                                                        <div class="form-group">
                                                            <input type="text"
                                                                class="form-control form-control-sm text-uppercase"
                                                                name="use_und_hbl_input" id="checkBoxUndHblInput"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-2">
                                                        <div class="form-group">
                                                            <label>Phone 1</label>
                                                            <input type="text" class="form-control form-control-sm"
                                                                name="phone_1_und_hbl" id="phone_1_und_hbl" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-2">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                id="fax_cons" value="{{ old('fax_cons') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                        ...
                                                                        <table id="tableContSeal"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><input type="text"
                                                                                        ...
                                                                                        value="{{ old('contName[0]') }}" />
                                                                                </td>
                                                                                <td><input type="text"
                                                                                        name="sealName[]" id="sealName1"
                                                                                        class="form-control form-control-sm input-sm text-uppercase"
                                                                                        value="{{ old('sealName[0]') }}" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <div align="right">
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-4">
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox"
                                                                ...
                                                                onclick="showDivCommodityHblAll()" value="0">
                                                    ...
                                                    <div class="col-1" hidden>
                                                        <div class="form-group">
                                                            <input type="text"
                                                                class="form-control form-control-sm text-uppercase"
                                                                name="use_commodity_hbl_input"
                                                                id="checkBoxCommodityHblInput" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
@section('scriptCreateJobsheet')
    ...
    <script>
        $(document).ready(function() {
            $('#checkBoxNotifyInput').val(0);
            $('#checkBoxNotify').on('change', function() {
                this.value = this.checked ? 1 : 0;
                $('#checkBoxNotifyInput').val(this.value).change();
            });
        });
    </script>

    <!-- Checkbox Undername H-BL/PEB -->
    <script>
        $(document).ready(function() {
            $('#checkBoxUndHblInput').val(0);
            $('#checkBoxUndHbl').on('change', function() {
                this.value = this.checked ? 1 : 0;
                $('#checkBoxUndHblInput').val(this.value).change();
            });
        });
    </script>

    <!-- Checkbox Commodity H-BL/PEB -->
    <script>
        $(document).ready(function() {
            $('#checkBoxCommodityHblInput').val(0);
            $('#checkBoxCommodityHbl').on('change', function() {
                this.value = this.checked ? 1 : 0;
                $('#checkBoxCommodityHblInput').val(this.value).change();
            });
        });
    </script>
