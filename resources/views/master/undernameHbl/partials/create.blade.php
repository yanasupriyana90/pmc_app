                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ Route('undernameHbl.store') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="inputCodeUndernameHbl">Code Undername H-BL / Booking</label>
                                                <input type="text" class="form-control form-control-sm text-uppercase"
                                                    name="code_undername_hbl" id="code_undername_hbl" value="{{ old('code_undername_hbl') }}" placeholder="Enter Code Undername H-BL / PEB">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="d-grid gap-2 d-md-block">
                                        ...
                                        <a href="{{ route('undernameHbl') }}" class="btn btn-danger" type="button">CANCEL</a>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </form>
