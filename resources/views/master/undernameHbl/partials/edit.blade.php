...
@section('subtitle', 'Undername H-BL / Booking')
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('undernameHbl.update', $undernameHbl->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="inputCodeUndernameHbl">Code Undername H-BL</label>
                                                <input type="text" class="form-control form-control-sm text-uppercase"
                                                    name="code_undername_hbl" id="code_undername_hbl"
                                                    value="{{ $undernameHbl->code_undername_hbl }}" placeholder="Enter Code Undername M-BL / PEB"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm text-uppercase" name="name"
                                            id="name" value="{{ old('name', $undernameHbl->name) }}" placeholder="Enter Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputAddress">Address</label>
                                        <textarea class="form-control form-control-sm text-uppercase" name="address" id="address" placeholder="Enter Address">{{ old('address', $undernameHbl->address) }}</textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="phone_1" id="phone_1"
                                                    value="{{ old('phone_1', $undernameHbl->phone_1) }}" placeholder="Enter Phone 1">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="phone_2" id="phone_2"
                                                    value="{{ old('phone_2', $undernameHbl->phone_2) }}" placeholder="Enter Phone 2">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="fax" id="fax"
                                                    value="{{ old('fax', $undernameHbl->fax) }}" placeholder="Enter Fax">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control form-control-sm" name="email" id="email"
                                                    value="{{ old('email', $undernameHbl->email) }}" placeholder="Enter Email">
                                            </div>
                                        </div>
                                        <div class="col-2 ml-5">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-sm select2" name="mandatory_tax_id" id="mandatory_tax_id"
                                                    ...
                                                    <option value="{{ old('mandatory_tax_id', $undernameHbl->mandatoryTax->id) }}">{{ $undernameHbl->mandatoryTax->name }}</option>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group row" id="tax_id_group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="tax_id" id="tax_id"
                                                    value="{{ old('tax_id', $undernameHbl->tax_id) }}" placeholder="Enter TAX ID">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-grid gap-2 d-md-block">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('undernameHbl') }}"
