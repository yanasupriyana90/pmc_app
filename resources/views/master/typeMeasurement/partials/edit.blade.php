                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('typeMeasurement.update', $typeMeasurement->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control text-uppercase"
                                                    name="code_measurement" id="code_measurement"
                                                    value="{{ $typeMeasurement->code_measurement }}" placeholder="Enter Code Measurement"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control text-uppercase" name="name"
                                            id="name" value="{{ $typeMeasurement->name }}" placeholder="Enter Name" required>
                                    </div>
                                    ...
                                    <div class="d-grid gap-2 d-md-block">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('typeMeasurement') }}"
