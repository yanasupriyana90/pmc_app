                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ Route('typeCurrency.store') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control text-uppercase"
                                                    name="code_currency" id="code_currency" placeholder="Enter Code Currency">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="d-grid gap-2 d-md-block">
                                        ...
                                        <a href="{{ route('typeCurrency') }}" class="btn btn-danger" type="button">CANCEL</a>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </form>
