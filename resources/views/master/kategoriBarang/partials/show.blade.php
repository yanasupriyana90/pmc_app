                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name"
                                            value="{{ $kategoriBarang->name }}" disabled>
                                    </div>

                                    <div class="d-grid gap-2 d-md-block">
                                        <a href="{{ route('kategoriBarang') }}" class="btn btn-success" type="button">OK</a>
                                        <a class="btn btn-primary" href="{{ route('kategoriBarang.edit', $kategoriBarang->id) }}"><i
