                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('categorySelling.update', $categorySelling->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control text-uppercase" name="name"
                                            id="name" value="{{ $categorySelling->name }}" placeholder="Enter Name" required>
                                    </div>
                                    ...
                                    <div class="d-grid gap-2 d-md-block">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('categorySelling') }}"
