                            ...
                            <form action="{{ Route('consignee.store') }}" method="POST">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm text-uppercase"
                                                    name="code_consignee" id="code_consignee" value="{{ old('code_consignee') }}" placeholder="Enter Code Consignee">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="d-grid gap-2 d-md-block">
                                        ...
                                        <a href="{{ route('consignee') }}" class="btn btn-danger" type="button">CANCEL</a>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </form>
